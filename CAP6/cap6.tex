...
Se lograron los objetivos planteados en el Capítulo~1, con los siguientes puntos:

\begin{itemize}
	\item \textbf{Determinar los parámetros OBD-II disponibles.} El escaneo de PIDs en ambos vehículos confirmó que el Changan Honor no soporta el PID 0x10 de MAF y que el Nissan Vanette sí; este hallazgo justificó adoptar Speed-Density como método principal de estimación.
	\item \textbf{Desarrollar el modelo matemático de estimación del consumo.} El modelo Speed-Density, corregido con los ajustes de combustible del ECU, quedó formalizado e implementado en firmware. Su componente de lazo cerrado con aprendizaje adaptativo se formalizó matemáticamente por completo; su implementación en firmware queda como trabajo futuro, detallado en la Sección~\ref{sec:escalabilidad}.
	\item \textbf{Recopilar datos del funcionamiento del motor.} El firmware sondea MAP, RPM, velocidad, IAT y los ajustes de combustible por CAN, y los registra junto con las variables derivadas en un archivo CSV por viaje en la tarjeta microSD.
	\item \textbf{Diseñar el sistema embebido de adquisición.} El hardware se diseñó y validó mediante un prototipo en protoboard, incluyendo la gestión de energía por dos rieles conmutados y un modo de bajo consumo activado por ausencia de contacto.
	\item \textbf{Integrar una plataforma telemétrica IoT.} El ESP32-S3 expone un panel web propio vía WiFi SoftAP, sin depender de conectividad externa ni de un servidor de terceros, con datos en vivo por WebSocket y descarga del histórico en CSV.
	\item \textbf{Evaluar el sistema en condiciones reales.} El sistema propio concuerda con el ELM327 dentro de un MAPE de $2{,}75\,\%$ y con el aforo real de tanque lleno dentro de un MAPE de $4{,}84\,\%$, un nivel de exactitud suficiente para el análisis de la autonomía planteado en el título de este trabajo; el detalle completo de esta validación se presenta en la Subsección~\ref{sec:conclusiones_validacion}.
\end{itemize}
...
\subsection{Conclusiones sobre la autonomía estimada}

Dividiendo la capacidad de tanque de cada vehículo, según la Tabla~\ref{tab:vehiculos} del Capítulo~4, entre la tasa de consumo medida sobre los nueve tramos combinados de las Tablas~\ref{tab:comparacion_consumo_vanette} y~\ref{tab:comparacion_consumo_changan}, el consumo estimado se traduce en una autonomía práctica por tanque lleno. El sistema propio estima $617$\,km para el Nissan Vanette, de tanque de $60$\,L, y $489$\,km para el Changan Honor, de tanque de $40$\,L. La autonomía realmente alcanzada, calculada igual pero a partir del aforo real de tanque lleno, fue de $575$\,km y $504$\,km respectivamente. La diferencia frente a la estimación del sistema, de $42$\,km y $15$\,km, es del mismo orden que el MAPE de consumo acumulado ya discutido en la Subsección~\ref{sec:conclusiones_validacion}: la exactitud del sistema en la estimación del consumo se traslada de forma consistente a la autonomía calculada, la magnitud de mayor interés práctico para el conductor y el objetivo central planteado en el título de este trabajo.
