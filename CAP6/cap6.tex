...
\begin{itemize}
	...
	\item \textbf{Evaluación del sistema en condiciones reales.} Se cumple, aunque con matices que se detallan en la Subsección~\ref{sec:conclusiones_validacion} (``Conclusiones sobre las pruebas y validación del sistema''). En síntesis: a nivel de consumo acumulado por trayecto —la magnitud relevante para retroalimentar al conductor y, por extensión, para el análisis de la autonomía planteado en el Capítulo~1— la exactitud alcanzada frente a las referencias comercial y real es suficiente para ese propósito, mientras que a nivel instantáneo la validación directa solo fue posible en el Nissan Vanette, dado que el Changan Honor no soporta el PID~0x10 (MAF).
\end{itemize}
...
A partir de las mismas cifras de consumo acumulado ya reportadas (Tablas~\ref{tab:comparacion_consumo_vanette} y~\ref{tab:comparacion_consumo_changan}, Capítulo~4) y de la capacidad de tanque de cada vehículo (Tabla~\ref{tab:vehiculos}, Capítulo~4), es posible traducir el consumo estimado a una autonomía práctica por tanque lleno: dividiendo la capacidad de tanque entre la tasa de consumo medida sobre los nueve tramos combinados, el sistema propio estima una autonomía de $617$\,km para el Nissan Vanette ($60$\,L, $12{,}09$\,L en $124{,}26$\,km) y de $489$\,km para el Changan Honor ($40$\,L, $9{,}34$\,L en $114{,}25$\,km). La autonomía realmente alcanzada, calculada de la misma forma a partir del aforo real de tanque lleno, fue de $575$\,km y $504$\,km respectivamente; la diferencia frente a la estimación del sistema ($42$\,km y $15$\,km) es del mismo orden que el MAPE de consumo acumulado ya discutido en la Subsección~\ref{sec:conclusiones_validacion}, lo que confirma que la exactitud del sistema en la estimación del consumo se traslada de forma consistente a la autonomía calculada, la magnitud de mayor interés práctico para el conductor del transporte público y el objetivo central planteado en el título de este trabajo.
