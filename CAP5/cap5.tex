...
\begin{figure}[H]
	...
	\vspace{2pt}
	{\footnotesize\textit{Nota.} Gráfico de líneas: costo fijo y ahorro acumulado son funciones continuas del tiempo, y lo relevante es el punto de cruce entre ambas. Los periodos de recuperación (2,44 y 3,21 meses) dependen de los valores de literatura de la Tabla~\ref{tab:payback} (kilometraje y reducción de consumo), así que deben leerse como una estimación, no como una garantía. Elaboración propia.}
\end{figure}
