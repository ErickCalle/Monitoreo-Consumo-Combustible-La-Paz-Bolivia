...
\begin{longtable}{@{}p{2.6cm}p{11.5cm}@{}}
	...
	MAPE & \textit{Mean Absolute Percentage Error}, error porcentual absoluto medio; métrica usada para cuantificar la exactitud del sistema propio frente a las referencias comercial y real. \\
