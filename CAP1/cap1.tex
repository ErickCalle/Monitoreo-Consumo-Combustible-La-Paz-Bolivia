...
\begin{itemize}
	...
	No obstante, el análisis experimental se limita exclusivamente a unidades seleccionadas que cumplen con el requisito de compatibilidad OBD-II.
	...
	interfaz OBD-II.
	\item Adicionalmente, la precisión del sistema depende del estado mecánico del vehículo. En vehículos con alto kilometraje o desgaste significativo, los valores obtenidos pueden presentar variaciones respecto a los valores ideales.
\end{itemize}
\clearpage